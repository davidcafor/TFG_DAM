 ...
 * @author David
 */
public class BajaInventario extends javax.swing.JDialog {

    /**
     * Creates new form BajaTienda
     */
    public BajaInventario(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(37, 37, 37)
                .addComponent(cmbInventario, javax.swing.GroupLayout.PREFERRED_SIZE, 556, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        setSize(new java.awt.Dimension(809, 162));
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (cmbInventario.getSelectedItem() != null) {
            ...
            int elementosEliminados = ControladorInventario.eliminarInventario(i.getId());
            ...
            JOptionPane.showMessageDialog(this, "Debes elegir un inventario a eliminar");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BajaInventario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BajaInventario dialog = new BajaInventario(new javax.swing.JFrame(), true);
